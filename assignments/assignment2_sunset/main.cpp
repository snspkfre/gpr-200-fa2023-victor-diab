...
int main() {
	...
	std::string vertexShaderSource = vd::loadShaderSourceFromFile("assets/vertexShader.vert");
	std::string fragmentShaderSource = vd::loadShaderSourceFromFile("assets/fragmentShader.frag");
